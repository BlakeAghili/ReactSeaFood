...
class EditFishForm extends React.Component {
    handleChange = (event) => {
        console.log(event.currentTarget.name); // this gives the name of the thing we are changing. Name attr of html form elements.
        // 1.take a copy of the current fish we are editing.
        const updatedFish = {
